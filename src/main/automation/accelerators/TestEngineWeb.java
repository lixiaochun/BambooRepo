package main.automation.accelerators;
...
import main.automation.report.ReporterConstants;
import main.automation.support.ExcelReader;
...
public class TestEngineWeb {
	...
	private void setWebDriverForLocal(String browser) throws IOException, InterruptedException
	{
		...
		/*	DesiredCapabilities objCapabilities = new DesiredCapabilities();
	        ...
	        eyes.setApiKey("8myUqf9MJvRx8w7KOcZqnZYtit6UCPvMgry3cWvSNwY110");
